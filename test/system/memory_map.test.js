...
(function testChipRamReadsAndWritesUseBigEndianBusSemantics() {
    var machine = new TestMachine({ fastRamSize: 0, overlay: false });
...
(function testFastRamLivesInAmigaExpansionSpace() {
    var machine = new TestMachine({ chipRamSize: 0x00080000, fastRamSize: 0x00400000 });
...
(function testOverlayHidesChipRamUntilDisabled() {
    ...
    var machine = new TestMachine({ rom: rom, fastRamSize: 0 });
