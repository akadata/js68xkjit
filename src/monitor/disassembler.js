...
function disassembleOne(machine, address) {
    ...
    if (line === 6) {
        ...
        var branchMnemonic = branchMap[cond];
        ...
        if (branchMnemonic) {
            if (dispIsWord) {
                ...
                return {
                    next: pc + 4,
                    text: branchMnemonic + '.W ' + formatBranchTarget(pc, disp16, 2)
                };
            }
            ...
            return {
                next: pc + 2,
                text: branchMnemonic + '.S ' + formatBranchTarget(pc, disp8, 2)
            };
        }
    }
